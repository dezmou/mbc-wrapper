...
describe("Main tests", function () {
  ...
  it("TokenURI test", async () => {
    ...
    await ctx.wrapped_mbc.connect(ctx.imp_gus).wrap(485, 1, 2, "", { value: ethers.utils.parseEther("2.4") });
    const tokenId = await ctx.wrapped_mbc.coordinateToTokenID(485, 1, 2);
